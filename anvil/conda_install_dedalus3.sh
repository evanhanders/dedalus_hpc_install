...
git clone https://github.com/DedalusProject/dedalus.git src_dedalus_v3
# CC=mpicc to ensure proper MPI linking
# no-cache to avoid wheels from previous pip installs
CC=mpicc python3 -m pip install --no-cache -e src_dedalus_v3
