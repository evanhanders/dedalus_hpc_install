...
# On expanse, you should load the following modules (or similar) before running this.
...
# no-cache to avoid wheels from previous pip installs
git clone -b v2_master https://github.com/DedalusProject/dedalus.git src/dedalus-d2
CC=mpicc python3 -m pip install -e src/dedalus-d2
